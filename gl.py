...
class Renderer(object):
    def __init__(self, width = 512, height =512): #Funcion glInit()
        self.width = width
        self.height = height
    ...
    def glLine(self, v0, v1, clr = None):
        ...
        #Si el punto0 es igual al punto1, solo se dibujara un punto
        if x0 == x1 and y0 == y1:
        ...
        #Se intercambian las x por las y, para dibujarse
        ...
        #intercambio a los puntos para siempre dibujarlos de izquierda
        #a derecha
        if x0 > x1:
            x0, x1 = x1, x0
            y0, y1 = y1, y0
